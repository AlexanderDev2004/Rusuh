...
interface CodexAccountFormProps {
  model: AddAccountModel['codex']
  limits: AddAccountModel['limits']
}

export function CodexAccountForm({
  model,
  limits,
}: CodexAccountFormProps) {
  return (
          ...
          <div className="dashboard-panel space-y-3 rounded-2xl p-4">
            ...
            <div className="flex justify-end">
              <Button
                ...
                variant="outline"
                onClick={() =>
                  window.open(model.authUrl, '_blank', 'noopener,noreferrer')
                }
        ...
        <div className="dashboard-panel space-y-3 rounded-2xl p-4">
          ...
          <div className="flex justify-end">
            <Button
              ...
              disabled={
                model.isSubmittingCallback ||
                model.callbackUrl.trim().length === 0
              }
              className="h-11 rounded-full px-5"
            >
